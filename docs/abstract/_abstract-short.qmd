...
**Results:**
Antidepressants ($c_e$: `r N06A$ce`, $n_c$: `r N06A$nc`) and anxiolytics ($c_e$: `r N05B$ce`, $n_c$: `r N05B$nc`) had high eigenvector centrality, indicating frequent co-prescription. Other drug groups with high centrality included those for the alimentary tract and metabolism (`A01-A16`), blood and blood-forming organs (`B01-B06`), cardiovascular system (`C01-C10`), analgesics (`N02`), and respiratory system (`R01-R07`).  
