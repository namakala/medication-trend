...
relative to the expected value \(C_e = \frac{1}{n}\), based on the null
...
supplementary file section S1.2.
...
\(C_e\) for each node in a uniformly connected network is
...
with \(c_i\) greater than \(\frac{1}{24}\) were categorized as having
