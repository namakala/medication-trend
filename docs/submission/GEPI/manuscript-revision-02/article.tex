...
centrality to evaluate which medications are central on the prescription
...
intervals for analysis. It includes four metrics: daily prescription
...
week, e.g.~\texttt{2018\ -\ W01}, whereas the yearly period was an order
from 2018 to 2022. We then grouped the series by its deconstructed
...
Therefore, this study only focused on the three categories that rely
solely on medication class information.
...
reference of uniform connectivity and unweighted network. Nodes with
...
The second categorization was based on general polypharmacy, defined as
...
subgroup using the same pre-processing and weighting procedures to
...
nationwide policy. There was no clear change in prescription trends
...
dispensing data. These decomposed trends provided the reconstructed data
...
vertical dashed line represents a reference value corresponding to equal
...
population, while the colored density areas represent the subgroups.}
